        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">selenium / Web Scraping</div>
                <div className="what-tags">Cloudinary / Imagekit.io</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Rich UI and UX Web Designs
                Mordern, Sleek Looking , minimalist web Design
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
